...
@run_async
def trendingfilms(bot: Bot, update: Update):
    res = "*Trending Movies:*\n\n"
...
@run_async
def trendingshows(bot: Bot, update: Update):
    res = "*Trending Shows:*\n\n"
...
SINFO_HANDLER = DisableAbleCommandHandler("INFO", sinfo)
...
UMOVIE_HANDLER = DisableAbleCommandHandler("upcoming", umovie)
dispatcher.add_handler(UPCOMING_HANDLER)

TRENDINGS_HANDLER = DisableAbleCommandHandler("trendingshows", trendings)
dispatcher.add_handler(TRENDINGSHOWS_HANDLER)

TRENDINGM_HANDLER = DisableAbleCommandHandler("trendingfilms", trendingm)
dispatcher.add_handler(TRENDINGFILMS_HANDLER)
